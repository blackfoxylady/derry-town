...
Исходные файлы и SHA-256 перечислены в `data/baseline.json`. EPUB, извлечённый текст романа и исследовательские промежуточные файлы не входят в приложение. Источники и ссылки на главы перенесены в БД.
