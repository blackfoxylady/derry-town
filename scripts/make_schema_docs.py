...
models=list(TABLES.values())+[m.Revision,m.MapState]
...
W,H=280,140
edges=[('Geometry','Feature',[(310,205),(440,205)]),('Geometry','Component',[(170,290),(170,390),(1000,390)]),('Feature','Component',[(720,235),(790,235),(790,300),(860,300)]),('Style','Component',[(1000,160),(1000,250)]),('Feature','Evidence',[(580,290),(580,480)]),('Source','Evidence',[(310,550),(440,550)]),('Feature','Label',[(720,190),(1190,190),(1190,565),(1140,565)]),('Revision','MapState',[(310,830),(440,830)])]
s=['<svg xmlns="http://www.w3.org/2000/svg" width="1220" height="1240" viewBox="0 0 1220 1240">','<rect width="1220" height="1240" fill="#f6f3e9"/>','<style>text{font-family:DejaVu Sans,sans-serif;fill:#263d38}.title{font-size:20px;font-weight:bold}.field{font-size:15px}.edge{fill:none;stroke:#75867b;stroke-width:2}</style>','<text x="30" y="38" class="title">Derry — database relationships</text>','<text x="30" y="69" class="field">PK: primary key · FK: foreign key · ?: nullable · 1 → many (MapState: at most one)</text>','<defs><marker id="arrow" markerWidth="10" markerHeight="10" refX="9" refY="5" orient="auto"><path d="M0 0L10 5L0 10" fill="none" stroke="#75867b"/></marker></defs>']
...
for name,(x,y,fields) in boxes.items():
 ...
 s.append('</g>')
s+=['<text x="30" y="1195" class="field">Setting and MapView have no relational foreign keys; JSON references are validated by the application.</text>','<text x="30" y="1222" class="field">Full field definitions: data_dictionary.md · Editable relationship source: er.mmd</text>','</svg>']
